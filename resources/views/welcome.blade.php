            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-7 text-align-right">
                    ...
                    <span class="email-icon"><i class="fa fa-envelope-o"></i> <a
                            href="#">caytuyaaram-online@gmail.com</a></span>
                </div>
    ...
    <section class="navbar navbar-default navbar-static-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <!-- lOGO TEXT HERE -->
                <a href="index.html" class="navbar-brand"><i class="fa fa-ambulance" aria-hidden="true"></i>Sen Caytu
                    Yaaram Online</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item">
                        @if (Route::has('login'))
                            ...
                            @else
                                <a href="{{ route('login') }}" type="submit" class="btn ml-2"
                                    style="background: #BEFF33;">Se Connecter</a>
                    ...
                    <div class="item item-first">
                        <div class="caption">
                            <div class="col-md-offset-1 col-md-10">
                                ...
                                <h1>Vie saine</h1>
                                <a href="#team" class="section-btn btn btn-default smoothScroll">Rencontrez nos
                                    médecins</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item item-second">
                        <div class="caption">
                            <div class="col-md-offset-1 col-md-10">
                                ...
                                <a href="#about" class="section-btn btn btn-default btn-gray smoothScroll">En savoir
                                    plus sur nous</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="about-info">
                        <h2 class="wow fadeInUp" data-wow-delay="0.6s">Bienvenue dans <i class="fa fa-stethoscope"
                                aria-hidden="true"></i>
                            Sen Caytu Yaaram Online</h2>
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            <p>Sen Caytu Yaaram Online est une première au Sénégal. Une clinique de nouveau 3 située
                                dans la capitale sénégalaise, très accessible</p>
                            <p>Nous proposons plusieurs services. Avec l'essor de la technologie, nous avons mis en
                                place une plateforme de consultation médicale en ligne</p>
                        </div>
                    </div>
                </div>
